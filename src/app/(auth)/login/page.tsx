    ...
    <div className="flex min-h-screen items-center justify-center p-4">
      <div className="w-full max-w-sm">
        <div className="mb-8 text-center">
          ...
          <p className="mt-2 dark:text-slate-400 text-slate-500">Remote control your Android device</p>
        </div>
        ...
        <div className="glass-card p-8 space-y-5">
          ...
          <div className="text-center space-y-1">
            ...
            <p className="text-sm dark:text-slate-400 text-slate-500">Sign in with Google to continue.</p>
          </div>
          ...
          <button onClick={handleSignIn} disabled={loading || status === "loading"}
            className="flex w-full items-center justify-center gap-3 rounded-xl border
              dark:border-white/20 border-slate-300 dark:bg-white/10 bg-white
              px-4 py-3 text-sm font-semibold shadow-sm transition
              hover:shadow-md dark:hover:bg-white/20 hover:bg-slate-50
              disabled:opacity-50 disabled:cursor-not-allowed active:scale-95">
            {loading
              ? <span className="h-5 w-5 animate-spin rounded-full border-2 dark:border-white/30 border-slate-400 border-t-blue-500" />
